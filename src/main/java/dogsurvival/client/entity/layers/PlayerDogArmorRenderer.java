...
public class PlayerDogArmorRenderer extends RenderLayer<AbstractClientPlayer, PlayerDogModel<AbstractClientPlayer>> {
    ...
    public PlayerDogArmorRenderer(RenderLayerParent parentRenderer, EntityRendererProvider.Context ctx) {
        super(parentRenderer);
        this.newModel = new DogArmorModel(ctx.bakeLayer(ModelLayerLocations.PLAYER_DOG_ARMOR));
        this.alternativeModel = new SyncedRenderFunctionWithHeadModel(ctx.bakeLayer(ModelLayerLocations.SYNCED_HEAD));
    ...
    @Override
    public void render(PoseStack poseStack, MultiBufferSource buffer, int packedLight, AbstractClientPlayer dog, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        if (dog.isInvisible()) {
            return;
        }
    ...
    private void checkAndRenderSlot(AbstractClientPlayer dog, EquipmentSlot slot, PoseStack stack, MultiBufferSource buffer, int light) {
    ...
    private Optional<Model> getAlternativeArmorModel(AbstractClientPlayer dog, EquipmentSlot slot, PoseStack stack, ItemStack itemStack) {
    ...
    private void startRenderAlternativeModelFromRoot(Model model, AbstractClientPlayer dog, PoseStack stack, MultiBufferSource buffer, int light, ItemStack itemStack, ArmorItem armor) {
