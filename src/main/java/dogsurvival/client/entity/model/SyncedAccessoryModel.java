...
public abstract class SyncedAccessoryModel extends EntityModel<AbstractClientPlayer> {

    public final ModelPart root;
    private Vector3f pivot = PlayerDogModel.DEFAULT_ROOT_PIVOT;
    ...
    public void sync(PlayerDogModel<? extends Player> dogModel) {
        ...
        pivot = PlayerDogModel.DEFAULT_ROOT_PIVOT;
    ...
    @Override
    public void prepareMobModel(AbstractClientPlayer dogIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
    }
